...
context = (function () {
	...
	function buildMenu(data, id, subMenu) {
		var subClass = (subMenu) ? ' dropdown-context-sub' : '',
			...
			$menu = $('<ul style="width: 5%" class="dropdown-menu dropdown-context' + subClass + compressed + '" id="dropdown-' + id + '"></ul>');
    ...
    function buildMenuItems($menu, data, id, subMenu, addDynamicTag) {
        ...
        for(var i = 0; i<data.length; i++) {
        	if (typeof data[i].divider !== 'undefined') {
                ...
                if (typeof data[i].contextAction == 'undefined') {
                    data[i].id = '';
                }
                ...
                if (typeof data[i].contextAction !== 'undefined') {
                    actionTarget = ' onclick="' + data[i].contextAction + '"';
                }
				if (typeof data[i].subMenu !== 'undefined') {
                    ...
                    element += '><a tabindex="-1" href="' + data[i].href + '"' + linkTarget + actionTarget + ' id="' + data[i].id + '" >';
