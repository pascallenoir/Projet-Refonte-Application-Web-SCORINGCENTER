...
(function (factory) {
    ...
    defaultFileActionSettings = {
        ...
        zoomTitle: 'Impossible de voir le contenu de ce fichier',
        dragIcon: '<i class="glyphicon glyphicon-menu-hamburger"></i>',
        dragClass: 'text-info',
        dragTitle: 'Déplacer / Redisposer',
        dragSettings: {},
        ...
        indicatorSuccessTitle: 'Transf&eacute;rer',
        indicatorErrorTitle: 'Erreur de Transfert',
        indicatorLoadingTitle: 'Transfert en cours ...'
    };
    tMain1 = '{preview}\n' +
    ...
    $.fn.fileinput.defaults = {
        ...
        browseClass: 'btn btn-cergicolor',
    ...
    $.fn.fileinputLocales.en = {
        fileSingle: 'Fichier',
        filePlural: 'Fichiers',
        browseLabel: 'Joindre un fichier &hellip;',
        removeLabel: 'Supprimer',
        removeTitle: 'Effacer le(s) fichier(s) s&eacute;lectionn&eacute;(s)',
        cancelLabel: 'Annuler',
        cancelTitle: 'Abort ongoing upload',
        uploadLabel: 'Transf&eacute;rer',
        uploadTitle: 'Transf&eacute;rer les fichiers f&eacute;lectionn&eacute;s',
        msgNo: 'Non',
        msgNoFilesSelected: 'Aucun fichier f&eacute;lectionn&eacute;',
        msgCancelled: 'Annulé',
        msgZoomModalHeading: 'Avant-premi&egrave;re d&eacute;taill&eacute;',
        ...
        msgInvalidFileType: 'Type Invalide pour le fichier "{name}". Uniquement ses types de fichiers : "{types}" sont support&eacute;s.',
        msgInvalidFileExtension: 'Extension Invalide pour le fichier "{name}". Uniquement ses types de fichiers : "{extensions}" sont support&eacute;s.',
        msgUploadAborted: 'Le fichier transf&eacute;r&eacute; est corrompu',
        msgUploadThreshold: 'Chargement en cours...',
        msgValidationError: 'Validation Error',
        msgLoading: 'Loading file {index} of {files} &hellip;',
        msgProgress: 'Loading file {index} of {files} - {name} - {percent}% completed.',
        msgSelected: '{n} {files} S&eacute;lection&eacute;s',
        ...
        dropZoneTitle: 'Déplacer & déposer les fichiers ici &hellip;',
        dropZoneClickTitle: '<br>(or click to select {files})',
        previewZoomButtonTitles: {
            prev: 'Voir le fichier pr&eacute;c&eacute;dent',
            next: 'Voir le fichier suivant',
            toggleheader: 'Supprimer l\'ent&ecirc;te',
            fullscreen: 'Basculer en plein &eacute;cran',
            borderless: 'Basculer en mode sans fronti&egrave;res',
            close: 'Fermer l\'avant-premi&egrave;re d&eacute;taill&eacute;'
        }
    };
