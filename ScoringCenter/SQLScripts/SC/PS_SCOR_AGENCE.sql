...
/****** Object:  StoredProcedure [dbo].[PS_SCOR_AGENCE]    Script Date: 13/03/2023 03:18:37 ******/
...
-- sélection des banques ayant le même groupe banque que @code_banque
if @bloc=7
begin
	select CODE_BANQUE,NOM_BANQUE,SIGLE_BANQUE,IMG_BANQUE,PAYS_CODE,GROUPE_BANQUE
	from SCOR_BANQUE where GROUPE_BANQUE = (select GROUPE_BANQUE from SCOR_BANQUE where CODE_BANQUE = @code_banque)
end
END
