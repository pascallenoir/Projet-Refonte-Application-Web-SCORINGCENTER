...
/****** Object:  Trigger [SCOR_UTILISATEUR_UP]    Script Date: 03/03/2023 04:02:48 ******/
DROP TRIGGER [dbo].[SCOR_UTILISATEUR_UP]
GO

/****** Object:  Trigger [dbo].[SCOR_UTILISATEUR_UP]    Script Date: 03/03/2023 04:02:48 ******/
SET ANSI_NULLS ON
GO
...
CREATE TRIGGER [dbo].[SCOR_UTILISATEUR_UP] 
...
DECLARE @ID_USER [dbo].[T_CODE_6] 
	...
	DECLARE @PCHNG [varchar](50)
		...
		UPDATE WEB_BILAN_DB.[dbo].[SCOR_UTILISATEUR]
     SET 
	   [ID_PROFIL] =REPLACE( RTRIM(LTRIM(@ID_PROFIL)),' ','')
      ,[CODE_AGENCE] = REPLACE( RTRIM(LTRIM(@CODE_AGENCE)),' ','')
      ,[NOM_USER] = RTRIM(LTRIM(@NOM_USER))
      ,[PRENOM_USER] = RTRIM(LTRIM(@PRENOM_USER))
      ,[EMAIL_USER] = RTRIM(LTRIM(@EMAIL_USER))
      ,[LOGIN_USER] = RTRIM(LTRIM(@LOGIN_USER))
      ,[PASSWORD_USER] = RTRIM(LTRIM(@PASSWORD_USER))
      ,[STATUT_USER] = @STATUT_USER
      ,[PARENT_SUPP] = @PARENT_SUPP
      ,[PCHNG] = @PCHNG
...
ALTER TABLE [dbo].[SCOR_UTILISATEUR] ENABLE TRIGGER [SCOR_UTILISATEUR_UP]
GO
