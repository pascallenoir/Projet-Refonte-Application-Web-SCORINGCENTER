<%@ Page Language="C#" MasterPageFile="~/Site.Master" EnableSessionState="True" AutoEventWireup="true" CodeBehind="Notes.aspx.cs" Inherits="ScoringCenter.Scoring.Notes" %>
...
<asp:Content ID="NotesMenu" ContentPlaceHolderID="ContentMenu" runat="server">
    ...
    <div id="Menu" class="pureCssMenu">
        ...
        <ul class="pureCssMenu pureCssMenum">                 
	        <li class="pureCssMenui"><a style="/*font-family: cursive;*/" class="pureCssMenui" href="AutreDossier.aspx">Autre Dossier</a></li>
            <li class="pureCssMenui "><a style="/*font-family: cursive;*/" class="pureCssMenui" href="TableauBord.aspx">Tableau de bord</a></li>
            <li class="pureCssMenui "><a style="/*font-family: cursive;*/" class="pureCssMenui" href="FicheSignaletique.aspx">Fiche signalitique</a></li>
            <li class="pureCssMenui"><a style="/*font-family: cursive;*/" class="pureCssMenui" href="HistoriqueNotation.aspx">Historique de notation</a></li>
            <li class="pureCssMenui"><a style="/*font-family: cursive;*/" class="pureCssMenui" href="#">Dossier de notation <i style="color: white; font-size: 6px;" class="glyphicon glyphicon-triangle-bottom"></i></a>
                <ul class="pureCssMenum" style="z-index: 10;">
		            <li class="pureCssMenui"><a style="/*font-family: cursive;*/ " class="pureCssMenui" href="AnalyseFinanciere.aspx">Analyse financière</a></li>
                    <li class="pureCssMenui"><a style="/*font-family: cursive;*/" class="pureCssMenui" href="AnalyseQualitative.aspx">Analyse qualitative</a></li>
                    <li class="pureCssMenui"><a style="/*font-family: cursive;*/" class="pureCssMenui" href="IntegrationGroupe.aspx">Intégration groupe</a></li>
                    <li class="pureCssMenui"><a style="/*font-family: cursive;*/" class="pureCssMenui" href="RisquePays.aspx">Risque pays</a></li>
                    <li class="pureCssMenui"><a  class="pureCssMenui" href="#">En Cours...</a></li>
                    <li class="pureCssMenui"><a style="/*font-family: cursive;*/" class="pureCssMenui" href="ValidationNote.aspx">Validation de la note</a></li>
                </ul>
            </li>
            <li class="pureCssMenui"><a style="/*font-family: cursive;*/  background-color: #022D65; color: #FFFFFF;" class="pureCssMenui" href="Notes.aspx">Annotation</a></li>
            ...
            <li class="pureCssMenui pull-right" style=""><a style="/*font-family: cursive;*/" class="pureCssMenui" href="EnvoiBilanFinancier.aspx">Envoi Bilan financier</a></li>
        </ul>
    </div>
            ...
            <div id="thebody">
                ...
                <div class="row inthebody br_topbody">
                    <div class="row" style="margin-left: 2%;  margin-right: 2%; margin-top: 0.5%;">
                        <div class="col-lg-12 col-sm-12 col-md-12">
                            <div class="row div_form">
                                <div class="col-lg-12 col-sm-12 col-md-12" style="max-height: 25%; overflow: hidden;">
                                    <div class="row" style="overflow: hidden; max-height: 20px; height: 20px; margin-bottom: 2%;">
                                    ...
                                    <div class="row" style="overflow: hidden; max-height: 20px; height: 20px; margin-bottom: 0%;">
                                        <div class="col-lg-4 col-sm-4 col-md-4 text-left">
                                            <b>
                        ...
                        <div class="col-lg-12 col-sm-12 col-md-12 center-block">
                            <h4>Message</h4>
                        </div>
                        <div class="col-lg-12 col-sm-12 col-md-12">
                            <div style="height: 150px; max-height: 150px; padding-left: 0.8%;" class="row">
                                <div style="overflow-y: scroll; height: 100%;" class="col-lg-12 col-sm-12 col-md-12" 
                        ...
                        <div>
                            <div style="padding-left: 0.8%;">
                                ...
                                <div class="col-lg-7 col-sm-7 col-md-7">
                                    <asp:TextBox ID="TbCommentaire" placeholder="Hermann HANNA, le 23/10/2016 12:00:02" runat="server" TextMode="MultiLine" CssClass="CommentLine form-control"
