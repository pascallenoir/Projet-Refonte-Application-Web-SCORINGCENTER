                            ...
                            <div class="col-lg-12 col-sm-12 col-md-12" style="padding: 0;">
                                <div class="col-lg-6 col-md-6 col-sm-6" style="padding: 0;">
                                    <div class="col-lg-12 col-sm-12 col-md-12" style="margin-bottom: -2.4%; margin-top: -0.5%;">
                                      ...
                                      <div class="col-lg-12 col-sm-12 col-md-12" style="margin-bottom: -2.4%; margin-top: 3%;">
                                        <div class="row div_form" style="background-color: rgba(208, 245, 117, 0.34);">
                                            <div class="EnteteInfo" style="text-align: center">
                                                <label for="">Paramètres d'aiguillage des modèles de notation</label></div>
                                                    ...
                                                    <div class="col-lg-6 col-sm-6 col-md-6">
                                                        <div style="display: inline; text-align: left; margin-left: 80%;">
                                                            ...
                                                            <button
                                                                ...
                                                                title="Valider"
                                                                runat="server"
                                                                id="ValideModele" onserverclick="ValideModele_ServerClick">
                                                                <span class=" glyphicon glyphicon-ok"></span>
                                                            </button>
                                                            <asp:TextBox ID="TextB22ox3" runat="server" CssClass="form-control Ddlsize display" Width="40"></asp:TextBox>

                                                            <input id="Hidden551" type="hidden" class="val22idate chec52ked_vNu22mordsM" runat="server" />
                                                            <input id="Hidde555n2" type="hidden" class="val22idate che2cked_vNu22mordsV" runat="server" />
                                            ...
                                            <div class="row push_entete">
                                                <div class="col-lg-5 col-sm-5 col-md-5 " style="text-align: right;">
                                                    Plafond du chiffre d'affaire <label style="color: red">*</label>
                                                </div>
                                                <div class="col-lg-3 col-sm-3 col-md-3" style="padding:0px;margin:0px" >
                                                    <input type="text" class="form-control cergiDecimalMoney" maxlength="17" runat="server" id="PlafondCA" nbDecimal="0" aria-describedby="telbur" style="text-align: left;width:100%;height:25px;padding-top:0px;padding-bottom:0px;"/>
                                               ...
                                               <div class="row push_entete">
                                                ...
                                                <div class="col-lg-3 col-sm-3 col-md-3" style="padding:0px;margin:0px" >
                                                  <input type="text" class="form-control " readonly id="SectAct" style="text-align: left;width:100%;height:25px;padding-top:0px;padding-bottom:0px;" value="Tous" disabled="disabled"/>
                                               ...
                                               <div class="row push_entete">
                                                <div class="col-lg-5 col-sm-5 col-md-5 " style="text-align: right;">
                                                    Codes activités économiques <label style="color: red">*</label>
                                                </div>
                                                <div class="col-lg-3 col-sm-3 col-md-3" style="padding:0px;margin:0px" >
                                                  <input type="text" class="form-control " readonly  id="CodeAct" style="text-align: left;width:100%;height:25px;padding-top:0px;padding-bottom:0px;" value="Tous" />
                                                </div>
                                                 <div class="col-lg-4 col-sm-4 col-md-4" style="text-align: left;">
                                                     PMI PME / Corporate
                                                </div>
                                               ...
                                               <div class="row push_entete">
                                                <div class="col-lg-5 col-sm-5 col-md-5 " style="text-align: right;">
                                                    Forme juridique <label style="color: red">*</label>
                                                </div>
                                                <div class="col-lg-3 col-sm-3 col-md-3" style="padding:0px;margin:0px" >
                                                 <input type="text" class="form-control " readonly id="FormeJuri" style="text-align: left;width:100%;height:25px;padding-top:0px;padding-bottom:0px;" value="Tous" />
                                                </div>
                                                 <div class="col-lg-4 col-sm-4 col-md-4" style="text-align: left;">
                                                     PMI PME / Corporate
                                                </div>
...
<%--                                        <div class="col-lg-12 col-sm-12 col-md-12">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6" style="padding: 0 0 0 4px;">
                                    <div class="col-lg-12 col-sm-12 col-md-12" style="margin-bottom: -2.4%; margin-top: -0.5%;">
                                        <div class="row div_form" style="background-color: rgba(208, 245, 117, 0.34);">
                                            <div class="EnteteInfo" style="text-align: center">
                                                <label for="">Gestion des habilitations</label></div>
                                            ...
                                            <div class="col-lg-12 col-sm-12 col-md-12">
                                                <div class="col-lg-9 col-sm-9 col-md-9">
                                                    <span>(
                                                        <label style="color: red;">M</label>) Valider, Modifier,Supprimer</span>
                                                </div>

                                                <div class="col-lg-3 col-sm-3 col-md-3">
                                                    <span>(
                                                        <label style="color: red;">V</label>) Visualiser</span>
                                                </div>
                                            </div>
            ...
            var TextBox2 = $("#<%=TextBox2.ClientID%>").val();
                ...
                $('.clickable').each(function (e) {
                    ...
                    $(".V_Cocher6").click(function () {
                        ...
                        if ($(".V_Cocher6").is(':checked') == false && $(".V_Cocher7").is(':checked') == false && $(".V_Cocher8").is(':checked') == false && $(".V_Cocher9").is(':checked') == false && $(".V_Cocher10").is(':checked') == false && $(".V_Cocher11").is(':checked') == false && $(".V_Cocher12").is(':checked') == false) {
                    ...
                    $(".M_Cocher12").click(function () {
                        if ($(".M_Cocher12").is(':checked')) {
                            $(".M_Cocher5").prop("checked", true);
                            $(".V_Cocher5").prop("checked", true);
                        }

                    });
                    $(".V_Cocher12").click(function () {
                        if ($(".V_Cocher12").is(':checked')) {
                            $(".V_Cocher5").prop("checked", true);
                        }
                        if ($(".V_Cocher6").is(':checked') == false && $(".V_Cocher7").is(':checked') == false && $(".V_Cocher8").is(':checked') == false && $(".V_Cocher9").is(':checked') == false && $(".V_Cocher10").is(':checked') == false && $(".V_Cocher11").is(':checked') == false && $(".V_Cocher12").is(':checked') == false) {
                            $(".V_Cocher5").prop("checked", false);
                    ...
                    $(".M_Cocher15").click(function () {
                        if ($(".M_Cocher15").is(':checked') == false) {
                            $(".M_Cocher19").prop("checked", false);
                    ...
                    $(".V_Cocher15").click(function () {
                        if ($(".V_Cocher15").is(':checked') == false) {
                            $(".V_Cocher19").prop("checked", false);
                    ...
                    $(".M_Cocher16").click(function () {
                        if ($(".M_Cocher16").is(':checked')) {
                            $(".M_Cocher15").prop("checked", true);
                            $(".V_Cocher15").prop("checked", true);
                        }
                    ...
                    $(".V_Cocher16").click(function () {
                        ...
                        if ($(".V_Cocher19").is(':checked') == false && $(".V_Cocher16").is(':checked') == false && $(".V_Cocher17").is(':checked') == false && $(".V_Cocher18").is(':checked') == false) {
                    ...
                    $(".M_Cocher19").click(function () {
                        if ($(".M_Cocher19").is(':checked')) {
                            $(".M_Cocher15").prop("checked", true);
                            $(".V_Cocher15").prop("checked", true);
                        }

                    });
                    $(".V_Cocher19").click(function () {
                        if ($(".V_Cocher19").is(':checked')) {
                            $(".V_Cocher15").prop("checked", true);
                        }
                        if ($(".V_Cocher19").is(':checked') == false && $(".V_Cocher16").is(':checked') == false && $(".V_Cocher17").is(':checked') == false && $(".V_Cocher18").is(':checked') == false) {
                            $(".V_Cocher15").prop("checked", false);
