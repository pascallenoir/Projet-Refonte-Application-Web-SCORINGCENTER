        ...
        <ul class="pureCssMenu ">
            ...
            <li class="pureCssMenui" id="DN" runat="server"><a style="/*font-family: cursive; */" class="pureCssMenui" href="#">Dossier de notation <i style="color: white; font-size: 6px;" class="glyphicon glyphicon-triangle-bottom"></i></a>
                <ul class="" style="z-index: 10;">
                    ...
                    <li class="pureCssMenui" id="AS" runat="server"><a style="/*font-family: cursive; */" class="pureCssMenui" href="DossierNotationGroupe.aspx">Analyse Structurelle</a></li>
        ...
        <div class="bigbody">
            ...
            <div id="thebody" class="noBackground">
                ...
                <div class="row inthebody br_topbody">
                    ...
                    <div class="row" id="Panneau1" runat="server" style="margin-left: 2%; margin-right: 2%; margin-top: 0.5%; text-align: left;">
                        <%--hiden--%>
                        ...
                        <div class="col-lg-12 col-sm-12 col-md-12" style="padding-top: 5.5px;">
                                ...
                                <div class="col-lg-12 col-sm-12 col-md-12 ">
                                    <div class="row div_form" style="background-color: rgba(208, 245, 117, 0.34);">
                                        ...
                                        <div class="row push_right" style="margin-left: -2.5%;">
                                            ...
                                            <div class="col-lg-3 col-sm-3 col-md-3">
                                                <asp:Label ID="LblChiffre" runat="server"></asp:Label>
                                            </div>
                                        </div>
                                        <div class="row push_right" style="fill: inherit">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6" style="padding: 0 0 0 4px;">
                                <div class="col-lg-12 col-sm-12 col-md-12" style="margin-bottom: -2.4%; margin-top: -0.5%;">
                                    <div class="row div_form" style="background-color: rgba(208, 245, 117, 0.34);">
                                        ...
                                        <div class="row push_right" style="margin-left: -2.5%;" hidden>
                                            <div class="col-lg-5 col-sm-5 col-md-5">
                                                Branche d'activité :
                                            </div>
                                            <div class="col-lg-7 col-sm-7 col-md-7">
                                ...
                                <div class="col-lg-12 col-sm-12 col-md-12">
                                    <div class="row div_form" style="background-color: rgba(208, 245, 117, 0.34);">
                                        <div class="EnteteInfo" style="text-align: center">
                                            <label for="">Saisies et analyses</label>
                                        </div>
                                        <div class="row push_right" style="margin-left: -2.5%;">
                                            <div class="col-lg-5 col-sm-5 col-md-5">
                                                Modèle d'analyse :
                        ...
                        <div class="row" style="margin-left: 2%; margin-right: 2%; margin-top: -5%; text-align: left;">
                            <div class="col-lg-12 col-sm-12 col-md-12" style="padding: 0;">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6" style="padding: 0 0 0 4px;">
                                    <div class="col-lg-12 col-sm-12 col-md-12" style="margin-bottom: -2.4%; margin-top: -0.5%;">
                                        <div class="row div_form" style="background-color: rgba(208, 245, 117, 0.34);">
                                            ...
                                            <div class="row push_right" style="margin-left: 6%;">
                                                ...
                                                <div class="col-lg-7 col-sm-7 col-md-7">
                                                    <asp:DropDownList ID="DdlBranchActiv" AutoPostBack="false"  onchange="combo007($(this),'C')" CssClass="form-control" runat="server" Width="100%" Style="height: 24px; padding-top: 0px; padding-bottom: 0px;">
                                                    </asp:DropDownList>
                                    ...
                                    <div class="col-lg-12 col-sm-12 col-md-12" style="margin-left: 30%">
                                        (
