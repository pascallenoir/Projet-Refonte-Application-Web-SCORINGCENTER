    ...
    <div id="Menu" class="pureCssMenu">
        ...
        <div id="Menu" class="pureCssMenu">
            ...
            <ul class="pureCssMenu ">
                ...
                <li class="pureCssMenui " id="FS" runat="server"><a style="/*font-family: cursive; */ background-color: #022D65; color: #FFFFFF;" class="pureCssMenui" href="FicheSignaletique.aspx">Fiche signalétique</a></li>
                <li class="pureCssMenui" id="HN" runat="server"><a style="/*font-family: cursive; */" class="pureCssMenui" href="HistoriqueNotation.aspx">Dossiers de notation</a></li>
                <li class="pureCssMenui" id="DN" runat="server"><a style="/*font-family: cursive; */" class="pureCssMenui" href="#">Effectuer une notation <i style="color: white; font-size: 6px;" class="glyphicon glyphicon-triangle-bottom"></i></a>
                    <ul class="" style="z-index: 10;">
                        <li class="pureCssMenui" id="NCP" runat="server"><a style="" class="pureCssMenui" href="#">Notation de la contrepartie <i style="color: white; font-size: 6px;" class="glyphicon glyphicon-triangle-bottom"></i></a>
                            <ul class="" style="z-index: 10;">
                                ...
                                <li class="pureCssMenui" id="AQ" runat="server"><a style="" class="pureCssMenui" href="AnalyseQualitative.aspx">Analyse qualitative</a></li>
                                <li class="pureCssMenui" id="AS" runat="server"><a style="" class="pureCssMenui" href="DossierNotationGroupe.aspx">Analyse Structurelle Groupe</a></li>
                                <li class="pureCssMenui" id="IG" runat="server"><a style="" class="pureCssMenui" href="IntegrationGroupe.aspx">Intégration groupe</a></li>
                                <li class="pureCssMenui" id="RP" runat="server"><a class="pureCssMenui" href="RisquePays.aspx">Risque pays</a></li>
                            </ul>
                        </li>
                        <li class="pureCssMenui" id="NOP" runat="server"><a style="" class="pureCssMenui" href="#">Notation de l'opération <i style="color: white; font-size: 6px;" class="glyphicon glyphicon-triangle-bottom"></i></a>
                            <ul class="" style="z-index: 10;">
