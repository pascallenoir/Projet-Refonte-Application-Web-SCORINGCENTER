...
<asp:Content ID="EnvoiBilanFinancierBody" ContentPlaceHolderID="ContentBody" runat="server">
                        ...
                        <div class="col-lg-12 col-sm-12 col-md-12">
                                    ...
                                    <div class="row"  >
                                                    ...
                                                    <div  class="col-lg-12 col-sm-12 col-md-12"  style="margin-bottom:1%;margin-top:-1%;padding-right:5%;">
                                                        <button type="button"
                                                        class="hidden btn btn-sm button_div pull-right"  onmousedown="con007($(this),'B')"
                                                        ...
                                                        <button class="btn btn_cergicolor btn_hover pull-right" type="button" id="ValideContrepartie" runat="server" onserverclick="ValideContrepartie_ServerClick" onmousedown="con007($(this),'B')" style="height: 25px; border: none; padding-top: 0px; padding-bottom: 0px; margin-right:-1.5%;">Enregistrer</button>
                                                                    ...
                                                                    <div class="row div_form" style="background-color:rgba(208, 245, 117, 0.34);">
                                                                        ...
                                                                        <div class="row push_right" style="margin-left: 6%;">
	                                                                        ...
	                                                                        <div class="col-lg-7 col-sm-7 col-md-7">
		                                                                        <input type="text" maxlength="50" class="form-control" runat="server" onchange="con007($(this),'T')" id="Nom" style="width:100%;height:24px;padding-top:0px;padding-bottom:0px;"/>
	                                                                        </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="row push_right" style="margin-left: 6%;">
                                                                            ...
                                                                            <div class="col-lg-7 col-sm-7 col-md-7">
                                                                                <input type="text" maxlength="50" class="form-control" onchange="con007($(this),'T')" runat="server" id="Adresse" style="width:100%;height:24px;padding-top:0px;padding-bottom:0px;"/>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="row push_right" style="margin-left: 6%;">
                                                                            ...
                                                                            <div class="col-lg-7 col-sm-7 col-md-7">
                                                                                <input type="text" id="Ville" maxlength="50" class="form-control" onchange="con007($(this),'T')" runat="server" style="width:100%;height:24px;padding-top:0px;padding-bottom:0px;"/>
                                                                            </div>
                                                                        </div>
                                                                          <div class="row push_right" style="margin-left: 6%;">
                                                                            <div class="col-lg-4 col-sm-4 col-md-4">
                                                                        ...
                                                                        <div class="row push_right"  style="margin-left: 6%;">
                                                                            ...
                                                                            <div class="col-lg-7 col-sm-7 col-md-7">
                                                                                <input type="text" id="Rccm" maxlength="50" onchange="con007($(this),'T')" class="form-control" runat="server" style="width:100%;height:24px;padding-top:0px;padding-bottom:0px;"/>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div class="col-lg-12 col-sm-12 col-md-12">
                                                                    <div class="row div_form" style="background-color:rgba(208, 245, 117, 0.34);">
                                                                        ...
                                                                        <div class="row push_right" style="margin-left: 6%;">
                                                                            ...
                                                                            <div class="col-lg-7 col-sm-7 col-md-7">
                                                                                <asp:Label ID="TxtBanque" runat="server" CssClass="boldSize" Text=""></asp:Label>                                                                            
                                                                            </div>
                                                                        </div>
                                                                        <div class="hidden row push_right" style="margin-left: 6%;">
                                                                            <div class="col-lg-4 col-sm-4 col-md-4">
                                                                                Segment clientèle 
                                                                            </div>
                                                                            <div class="col-lg-7 col-sm-7 col-md-7">
                                                                                <input type="text" maxlength="50" id="Segment" value="Segment ()" onchange="con007($(this),'T')" class="form-control" runat="server" style="width:100%;height:24px;padding-top:0px;padding-bottom:0px;"/>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row push_right" style="margin-left: 6%;">
                                                                            <div class="col-lg-4 col-sm-4 col-md-4">
                                                                       ...
                                                                       <%--     <div class="col-lg-1 col-sm-1 col-md-1" style="margin-left:-17%">
                                                                        ...
                                                                        <div class="hidden row push_right" style="margin-left: 6%;">
                                                                            ...
                                                                            <div class="col-lg-7 col-sm-7 col-md-7">
                                                                                <input type="text" id="Ca" maxlength="17" value="0" class="form-control cergiDecimalMoney" nbDecimal="0" onchange="con007($(this),'T')" runat="server" style="width:76%;height:24px;padding-top:0px;padding-bottom:0px;"/>
                                                                            </div>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6" style="padding: 0 0 0 4px;">
                                                                 <div class="col-lg-12 col-sm-12 col-md-12" style="margin-bottom: -2.4%; margin-top: -0.5%;">
                                                                    <div class="row div_form" style="background-color:rgba(208, 245, 117, 0.34);">
                                                                        ...
                                                                        <div class="row push_right hide" style="margin-left: 6%;">
                                                                            <div class="col-lg-4 col-sm-4 col-md-4">
                                                                                Branche  d'activité
                                                                                <label style="color: red">*</label>
                                           ...
                                           <%--                                      <select runat="server" id="DdlBranchActive1" class="form-control" style="width:100%;height:85%" >
                                                <option></option>
                                                                        ...
                                                                        <div class="row push_right" style="margin-left: 3%;">
                                                                            <div class="col-xs-1" style="width: 38%; padding-right:0;">
                                                ...
                                                <option></option>
                                                                ...
                                                                <div class="col-lg-12 col-sm-12 col-md-12" style="margin-bottom: -2.4%">
                                                                    <div class="row div_form" style="background-color:rgba(208, 245, 117, 0.34);" >
                                                                        <div class="EnteteInfo" style="text-align:center"><label for="">Informations financières</label></div>
                                                ...
                                                <option value="MILLIONS">Millions</option>
                                                                        ...
                                                                        <div class="hidden row push_right" style="margin-left: 6%;">
                                                                           ...
                                                                           <div class="col-lg-3 col-sm-3 col-md-3">
                                                                                <input type="radio" name="ent"  id="R_non" class="entreprise" onchange="con007($(this),'T')" runat="server" /> NON
                                                                            </div>
                                                                            <div class="col-lg-3 col-sm-3 col-md-3">
                                                                                <input type="radio" name="ent"  id="R_oui" class="entreprise1" onchange="con007($(this),'T')" runat="server" /> OUI
                                                                            </div>
                                                                        ...
                                                                        <div class="hidden row push_right" style="margin-left: 6%;">
                                                                            ...
                                                                            <div class="col-lg-3 col-sm-3 col-md-3">
                                                                                <input type="radio" name="Gp"  id="G_non" class="groupe" runat="server" onchange="con007($(this),'T')"/> NON
                                                                            </div>
                                                                            <div class="col-lg-3 col-sm-3 col-md-3">
                                                                                <input type="radio" name="Gp"  id="G_oui" class="groupe1"  runat="server" onchange="con007($(this),'T')"/> OUI
                                                                            </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-10 col-sm-10 col-md-10" style="text-align: left">
                                ...
                                <asp:TextBox runat="server" MaxLength="50" ID="TbSearchMatricule" Height="28" 
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-10 col-sm-10 col-md-10" style="text-align: left">
                                ...
                                <asp:TextBox runat="server" MaxLength="50" ID="TbSearchAgence" Height="28" 
                                    CssClass="form-control" Width="205"></asp:TextBox><br />
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-10 col-sm-10 col-md-10" style="text-align: left">
                                ...
                                <asp:TextBox runat="server" MaxLength="50" ID="TbSearchActivite" Height="28" 
                                    CssClass="form-control" Width="205"></asp:TextBox><br />
                            </div>
                        </div>
                        <div class="row">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-11 col-sm-11 col-md-11" >
                            ...
                            <asp:TextBox runat="server" MaxLength="50" ID="ImpFiliale" Height="28" 
                                         CssClass="form-control" Width="205"></asp:TextBox><br />
                                <asp:TextBox runat="server" MaxLength="50" ID="Idscor" Height="28" 
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-10 col-sm-10 col-md-10" style="text-align: left">
                                ...
                                <asp:TextBox runat="server" MaxLength="50" ID="TbSearchPays" Height="28" 
                                    CssClass="form-control" Width="205"></asp:TextBox><br />
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-10 col-sm-10 col-md-10" style="text-align: left">
                                ...
                                <asp:TextBox runat="server" MaxLength="50" ID="TbSearchGroupe" Height="28" 
                                    CssClass="form-control" Width="205"></asp:TextBox><br />
                            </div>
                        </div>
                        <div class="row">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-10 col-sm-10 col-md-10" style="text-align: left">
                                <i>Saisir le groupe recherché</i><br />
                                <asp:TextBox runat="server" MaxLength="50" ID="TbSearchModele" Height="28" 
                                    CssClass="form-control" Width="205"></asp:TextBox><br />
                            </div>
                        </div>
                        <div class="row">
    ...
    <script>
        ...
        $(document).change(function () {
            $("#<%=Nom.ClientID%>").val($("#<%=Nom.ClientID%>").val().replace(/</g, "").replace(/>/g, "").replace(/\//g, ""));
            $("#<%=Adresse.ClientID%>").val($("#<%=Adresse.ClientID%>").val().replace(/</g, "").replace(/>/g, "").replace(/\//g, ""));
            $("#<%=Ville.ClientID%>").val($("#<%=Ville.ClientID%>").val().replace(/</g, "").replace(/>/g, "").replace(/\//g, ""));
            $("#<%=TbPays1.ClientID%>").val($("#<%=TbPays1.ClientID%>").val().replace(/</g, "").replace(/>/g, "").replace(/\//g, ""));
            $("#<%=Rccm.ClientID%>").val($("#<%=Rccm.ClientID%>").val().replace(/</g, "").replace(/>/g, "").replace(/\//g, ""));
            $("#<%=Segment.ClientID%>").val($("#<%=Segment.ClientID%>").val().replace(/</g, "").replace(/>/g, "").replace(/\//g, ""));
            $("#<%=DdlAgence.ClientID%>").val($("#<%=DdlAgence.ClientID%>").val().replace(/</g, "").replace(/>/g, "").replace(/\//g, ""));
            $("#<%=Tbgroupe1.ClientID%>").val($("#<%=Tbgroupe1.ClientID%>").val().replace(/</g, "").replace(/>/g, "").replace(/\//g, ""));
            $("#<%=Ca.ClientID%>").val($("#<%=Ca.ClientID%>").val().replace(/</g, "").replace(/>/g, "").replace(/\//g, ""));
            $("#<%=DdlBranchActiv.ClientID%>").val($("#<%=DdlBranchActiv.ClientID%>").val().replace(/</g, "").replace(/>/g, "").replace(/\//g, ""));
            $("#<%=DdlSecteurActive1.ClientID%>").val($("#<%=DdlSecteurActive1.ClientID%>").val().replace(/</g, "").replace(/>/g, "").replace(/\//g, ""));
            $("#<%=TbActivite1.ClientID%>").val($("#<%=TbActivite1.ClientID%>").val().replace(/</g, "").replace(/>/g, "").replace(/\//g, ""));
            $("#<%=DdlStatut.ClientID%>").val($("#<%=DdlStatut.ClientID%>").val().replace(/</g, "").replace(/>/g, "").replace(/\//g, ""));
            $("#<%=DblUntie.ClientID%>").val($("#<%=DblUntie.ClientID%>").val().replace(/</g, "").replace(/>/g, "").replace(/\//g, ""));
            $("#<%=DeviseD.ClientID%>").val($("#<%=DeviseD.ClientID%>").val().replace(/</g, "").replace(/>/g, "").replace(/\//g, ""));
